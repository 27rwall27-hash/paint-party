...
/** One of the 4 stable player identities — id 0 is always the human, ids 1-3 are CPU-filled.
 * Mirrors Stampede Sprint's RacerIdentity convention exactly (same id/color/isBot shape). */
